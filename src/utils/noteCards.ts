...
Sector slicing works about a single axis, so the hollow cube's other two shafts are handled the general way instead — broken into convex pieces by V-HACD. Every hollow shape gets that treatment now, whether or not anything pierces it.
