      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/90 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-cyan-50 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 rounded-xl border border-cyan-200 dark:border-cyan-500/20">
          ...
          {!isProAccount() ? (
            <div className="text-center py-10 bg-slate-50 dark:bg-slate-950/40 rounded-xl border border-slate-200 dark:border-slate-800 px-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block mt-4 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg font-bold text-xs"
              >
                See PhysBox Pro
              </a>
            </div>
                ...
                <div key={idx} className="bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-5 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Device ID: <code className="text-cyan-600 dark:text-cyan-300">{item.deviceId || 'Primary CNC'}</code></p>
                    </div>
