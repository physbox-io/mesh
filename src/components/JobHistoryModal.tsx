      ...
      >
        ...
        {!signedIn ? (
          ...
          <div className="px-6 py-8 text-sm">
            <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 font-bold mb-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block mt-5 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg font-bold text-xs"
            >
              See PhysBox Pro
            </a>
          </div>
